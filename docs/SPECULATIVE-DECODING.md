...
([#1314](https://github.com/mudler/vllm.cpp/issues/1314)). Nothing in #1628 was
run on a device: the packed-head equality is gated on CPU, and the CUDA arm and a
real NVFP4 target are owed a measurement.
