...
| Nemotron-3.5-Lightning-30B-A3B (Mamba2 + GQA + relu2 MoE) | **Host and Thor sm_110 gates PASS 96/96 `STRICT PASS`, the latter with the device FP8 mamba arm; sm_121a re-run pending** | ABI-only driver; G-SAFE `num_reqs <= 1`. The 23 FP8 Mamba2 blocks reach the device (A2-Q1, [#810](https://github.com/mudler/vllm.cpp/issues/810)); `lm_head` is the last host arm |
