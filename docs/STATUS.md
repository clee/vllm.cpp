...
| Nemotron-3.5-Lightning-30B-A3B (Mamba2 + GQA + relu2 MoE) | **A3 gate 96/96 `STRICT PASS` on GB10** under [#1157](https://github.com/mudler/vllm.cpp/issues/1157), 4/24 reverted. **No speed number; PENDING a resource** ([#1250](https://github.com/mudler/vllm.cpp/issues/1250)) | ABI-only driver; G-SAFE `num_reqs <= 1`. 23 of 52 layers still bounce to the host per token, plus the NVFP4 `lm_head`; seam [#1217](https://github.com/mudler/vllm.cpp/issues/1217) |
