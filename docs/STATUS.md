...
| LTX-2.5 (`LTX2VideoTransformer3DModel`, video+audio DIFFUSION) | **`SPIKE` , L0 spec committed 2026-08-11 (#435).** 21.00B / 48 blocks, geometry measured from the checkpoint header. No forward yet | L1-L7: `VideoEngine` seam + ABI v13, DiT forward, Gemma-4 TE, VAEs, pipeline, NVFP4 arms, dgx e2e |
