...
| MiniMax-Music3 (`MiniMaxMusic3ForConditionalGeneration`, text-to-MUSIC) | **`ACTIVE`: W0, W1, W2/W3, W4/W5, W6 and W7 landed (#672).** First row whose oracle is not vLLM: the OPEN diffusers PR #14456 `c6da9936`, which generates audio here | W2's LM forward and the GGUF k-quant ARM owed. W7 is a REFUSAL, not an arm: 8 quant formats refused by name, none loaded. No speed or quantized tolerance is claimed |
