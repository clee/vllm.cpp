...
| Nemotron-3.5-Lightning-30B-A3B (Mamba2 + GQA + relu2 MoE) | **Runs e2e through `include/vllm.h`; token gate FAILS 6/96** ([#1157](https://github.com/mudler/vllm.cpp/issues/1157)) | Loads the 20.1 GiB checkpoint and generates. Token 0 correct on all 3 prompts, decode then collapses to a repeated id: the recurrent carry, not drift |
