...
| LTX-2.5 throughput | `PENDING`, no number. vLLM-Omni has no native 2.5 path (vllm-omni#6066); its diffusers adapter is a black box, so not vLLM's production denominator | Opens on native upstream 2.5; correctness gateable |
