...
| **NemotronH single-step mamba decode** (`A2-D1`, [#1311](https://github.com/mudler/vllm.cpp/issues/1311)) | Thor sm_110 and GB10 sm_121a, c1 greedy, same-binary A/B, n=1 per leg | **TOKEN-NEUTRAL on both hosts:** each returns the SAME verdict on both arms -- sm_110 `96/96 STRICT PASS`, sm_121a `95/96 DIVERGENCE` ([#1388](https://github.com/mudler/vllm.cpp/issues/1388), not this row) | **SPEED REFUTED on both:** +0.388% sm_110, -1.991% sm_121a, under #1311's 3% bar and in OPPOSITE directions. See [`benchmark-record.md`](../.agents/benchmark-record.md) |
