...
| **Device expert slices (`ENG-EXPERT-STREAM-DEVICE`, [#1124](https://github.com/mudler/vllm.cpp/issues/1124))** | `UD-Q1_0` 370 GiB, one GB10, greedy 32 tok, one lease, 2026-08-18, [spec](../.agents/specs/expert-stream-device-slots.md) | **CPU MEASURED**, replacing VOID #912 F1: **11.05 s/tok** steady, 2 reps, live cache. **CUDA has no number:** it loads, then dies in forward 1, 0 steps, 7 tries ([#1299](https://github.com/mudler/vllm.cpp/issues/1299)) | correct answer; no oracle runs this |
