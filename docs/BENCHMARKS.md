...
| MiniMax-Music3 vocoder decode-window SCALING (#672, [#1664](https://github.com/mudler/vllm.cpp/issues/1664)) | Thor sm_110 lease, ONE boot, distinct binary sha256. **Shipped arm, PAIRED:** 7 alternated rounds after a 300 s settle, **1.067x** at 86 latents. `vocoder.snake` **11.96x** | **2.81x -> 11.48x is arm C, blocked UNCONDITIONALLY, not the shipped tree**, which has ONE point and no sweep; **4.11x** is COMPOSED across jobs. Both owed ([#1683](https://github.com/mudler/vllm.cpp/issues/1683)) |
