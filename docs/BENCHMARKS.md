...
| **NemotronH single-step mamba decode** (`A2-D1`, [#1311](https://github.com/mudler/vllm.cpp/issues/1311)) | Thor sm_110 and GB10 sm_121a, c1 greedy, same-binary A/B, n=1 per leg | **sm_110: A3 `96/96 STRICT PASS` BOTH legs; speed REFUTED at +0.388% under #1311's 3% bar.** ⛔ **sm_121a: `95/96 DIVERGENCE`, and whether A2-D1 CAUSES it is NOT established** | Attribution is the OFF leg, running. Decode drops to 0 chunk scans and 0 gather/scatter, so c1 decode is NOT launch-bound. See [`benchmark-record.md`](../.agents/benchmark-record.md) |
