...
| **Device expert slices (`ENG-EXPERT-STREAM-DEVICE`, [#1124](https://github.com/mudler/vllm.cpp/issues/1124))** | Qwen3.8-2.4T-A95B `UD-Q1_0`, `--device cuda` vs `cpu`, one GB10, greedy, 32 tokens | Decode **PENDING**: W0e queued, no floor. W0a **MEASURED** (`dgx:gpu0`, `PAGEABLE_OK`): pageable=1, integrated=1, a kernel read+wrote a 2,490,368 B host-vector slot, 2.06-2.28x. [record](../.agents/benchmark-record.md) | correct answer; no oracle runs this |
