...
| MiniMax-Music3 depth stage, x86-64 20-core (#672) | STAGE A/B at the real geometry, min of 12 rounds/arm over 8 alternating pairs: one frame **5.8667 -> 1.6766 s, 3.50x**. Fingerprint identical on all 20 runs | Thor per-stage e2e pair QUEUED, so the ratio against #1231's 347.3 s is PENDING. Box at load 39-52, hence a minimum. Detail: benchmark-record |
