...
| MiniMax-Music3 vocoder decode-window SCALING (#672, [#1664](https://github.com/mudler/vllm.cpp/issues/1664)) | Thor sm_110 lease, ONE boot, 4 trees, distinct binary sha256, 7 alternated rounds: scaling **2.81x -> 11.48x of 14 threads**, arm-to-arm **4.11x** at 86 latents; `vocoder.snake` **11.96x** | NOT the conv: `vt::Conv1d` already scaled 12.44x; an unpartitioned activation was **79.35 %** of the window. §18.8b's bandwidth candidate REFUTED by ablation. Detail: benchmark-record |
