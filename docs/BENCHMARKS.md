...
| Qwen3.5-4B | bf16 direct-load | 0.26.0.dev0, UNFUSED denominator | **1.0283x tput, `PENDING` and OPTIMISTIC** | OPTIMISTIC, oracle ran UNFUSED ([#1345](https://github.com/mudler/vllm.cpp/issues/1345), #414). TTFT/TPOT/E2E 1.085/1.017/1.029x ([data](bench-evidence/qwen35-4b-sm120-main-20260807.md)) |
