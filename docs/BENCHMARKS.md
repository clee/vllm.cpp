...
| LTX-2.5 axes | Speed `PENDING` (vllm-omni#6066 has no native 2.5; its adapter is a black box), binding oracle too. **SIZE: 320x192/25f completes on GB10, 448x256/25f does not** | The wall is the HOST VAE decode, not the pool: the drain returns 0.11 GiB, byte-inert |
