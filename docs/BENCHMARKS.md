...
| **NemotronH single-step mamba decode** (`A2-D1`, [#1311](https://github.com/mudler/vllm.cpp/issues/1311)) | **PENDING on a leased GPU:** the landing change claims NO throughput, latency or occupancy number | Correctness gated; launch/alloc counts are ARITHMETIC, not profiled. See [`benchmark-record.md`](../.agents/benchmark-record.md) `A2-D1` |
