...
| Native Windows builds | ◐ CPU/Vulkan: `/MT /W4 /WX`, `NOMINMAX`, UTF-8, aligned allocation, runtime ISA dispatch. Issue #537 has an isolated ordered constructor/KV/CRT witness. Local float probe green; hosted compile/runtime/release pending | ✅ | ✅ | ✅ |
