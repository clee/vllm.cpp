...
| LTX-2.5 quantized loaders (FP8 + torchao-NVFP4) | LTX-2.5 `22b-distilled-fp8` (6124 tensors), `gemma4-12b-with-proj-nvfp4-torchao` (1688) | 19/19 on the SHIPPED manifests, their own bytes vs torch fp8-e4m3, and synthetic loads. bf16 default, f32 opt-in | torchao NVFP4 adds NO quant scheme; the delta is a swizzled scale layout. Shipped DiT refused by name for 4 unported families. NVFP4 DiT synthetic only, checkpoint HF-gated |
