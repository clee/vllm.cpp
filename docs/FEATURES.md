...
| `NemotronHForCausalLM` | Nemotron-3.5-Lightning-30B-A3B-NVFP4 (`nvidia` @`29f2d174`) | config+enumeration+KV-shape gated; hybrid Mamba2/GQA/relu2-MoE forward COMPUTES on landed `vt::Mamba2*` ops (#496). Loader loads 18487/18487 SHIPPED (5935 NVFP4 g16, 46 FP8 W8A8, bf16); 270 MTP owed W5 (#517) | Engine reads the model's OWN KV spec (#810 A1). A2-R (norms, 6 GQA) + A2-Q2a (23 MoE, NVFP4 g16 Marlin) are device arms NOT REACHABLE: G-SAFE refuses first; A2-P owns wiring (#810). No e2e gate, no number (#1074) |
