...
| ModelOpt `MIXED_PRECISION` (`quantized_layers`, exact module names) | ◐ the declared `quant_algo` is CROSS-CHECKED against the shipped operand names at load; a disagreement or an unimplemented algo is REFUSED BY NAME. `r0b0tlab/Qwen3.8-27B-NVFP4-MTP-sm121` loads both halves (#821) | ✅ | ✅ | ☐ |
