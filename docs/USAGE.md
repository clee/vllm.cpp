...
and through the `ltx2-gen` example that drives it. Two limits decide what you can
actually ask for, and both refuse by name rather than rendering something else.
